    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <main class="h-full pb-16 overflow-y-auto">
                <a href="{{ route('listpenunjangs.index')}}">
                    <button
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <form name="daftar" action="{{ route('listpenunjangs.update',$listpenunjang->id) }}" method="POST" 
                        ...
                        <label class="block text-sm mt-3">
                            ...
                            <input type="text"
                                ...
                                name="nama" placeholder="nama" value="{{$listpenunjang->nama}}" />
                        </label>
                        ...
                        <label class="block text-sm mt-3">
                            ...
                            <input type="text"
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:ring-2 focus:ring-blue-600 dark:text-gray-300 dark:focus:shadow-outline-gray form-input rounded-md"
                                name="keterangan" placeholder="keterangan" value="{{$listpenunjang->keterangan}}" />
                        </label>
                        <div class="mt-5">
                            <button type="submit"
