<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            {{-- <a href="{{route('daftaraktifs.showall')}}">
                <button
            ...
            @php
                ...
                $count = 0;
            @endphp
            @foreach ($daftar_aktifs as $daftar)
                @php
                                    ...
                                    <td
                                        ...
                                        <span
                                            class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Aksi</span>
                                                <a href="{{ route('daftaraktifs.show', $data[$i][3]) }}" class="text-blue-400 hover:text-blue-600 underline">
                                                    Lihat
                                                </a>
                                                <a href="{{ route('daftaraktifs.edit', $data[$i][3]) }}" class="ml-2 text-blue-400 hover:text-blue-600 underline">
                                                    Lanjut
                                                </a>
                                                <a href="{{URL::to('/daftaraktifs/destroy/.',$data[$i][3]) }}" class="ml-2 text-blue-400 hover:text-blue-600 underline"
