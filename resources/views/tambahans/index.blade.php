<x-app-layout>
    ...
    <div class="mx-auto sm:px-6 lg:px-8 my-3">
        ...
        {{-- <input class="border-2 border-gray-300 bg-white mr-16 pr-16 rounded-lg text-sm focus:outline-none float-right "
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td
                            ...
                            <a href="{{ route('tambahans.edit', $tambahan->id) }}" class="text-blue-400 hover:text-blue-600 underline">Edit</a>
                            <a href="{{URL::to('/tambahans/destroy/.',$tambahan->id) }}" class="text-blue-400 hover:text-blue-600 underline pl-6"
        ...
        htmlView += `
            <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                ...
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                    <span
                        class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Aksi</span>
                        <a href="/tambahans/`+res.employees[i].id+`/edit" class="text-blue-400 hover:text-blue-600 underline">Edit</a>
                        <a href="{{URL::to('/tambahans/destroy/.',`+res.employees[i].id+`) }}" class="text-blue-400 hover:text-blue-600 underline pl-6"
